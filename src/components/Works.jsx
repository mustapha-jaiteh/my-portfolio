      ...
      >
        <div className="relative w-full h-[230px] ">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover ">
            {/* website link {deployed_link} */}
            <div
              onClick={() => window.open(website_link, "_blank")}
              className="bg-blue-500 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer mr-2"
            >
              <LinkIcon className="w-1/2 h-1/2 object-contain " />
            </div>

            {/* github link {source_code_link} */}
            <div
        ...
        <div className="mt-5 flex flex-col flex-1">
          ...
          <p className="mt-2 text-secondary text-[16px] font-semibold flex-1">
            {description}
          </p>
        </div>
